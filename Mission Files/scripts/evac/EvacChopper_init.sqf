...
evac_AllowedChoppers = [
	"AH6X_DZ","AH6J_EP1","BAF_Merlin_DZE","CH_47F_EP1_DZ","CH_47F_EP1_DZE","CSJ_GyroC",
	"CSJ_GyroCover","CSJ_GyroP","Mi17_Civilian","Mi17_Civilian_DZ","Mi17_DZ","Mi17_DZE","MH6J_DZ","MH6J_EP1","MH60S_DZ","MH60S_DZE",
	"UH1H_DZ","UH1H_DZE","UH1Y_DZ","UH1Y_DZE","UH60M_EP1_DZ","UH60M_EP1_DZE","UH60M_MEV_EP1","pook_H13_medevac","pook_H13_transport"
];
/////////////////////////////////////////////////
/////////////// DONT EDIT BELOW ! ///////////////
/////////////////////////////////////////////////
						...
						if (evac_vehicleKey != "0") then {
							...
							if (evac_hasKey) then {
								...
								if (s_player_makeEvacChopper < 0) then {
									s_player_makeEvacChopper = player addAction [("<t color=""#0000FF"">" + ("Set Evac-Chopper") + "</t>"),"scripts\evac\SetEvacChopper.sqf",evac_cTarget,-1000,false,false,"",""];
								};
								...
								if (playerHasEvacField) then {
									...
									if ((evac_cTarget distance playersEvacField) <= 10) then {
										...
										if (s_player_clearEvacChopper < 0) then {
											s_player_clearEvacChopper = player addAction [("<t color=""#0000FF"">" + ("Clear Evac-Chopper") + "</t>"),"scripts\evac\ClearEvacChopper.sqf",evac_cTarget,-1001,false,false,"",""];
										};
							...
							if (evac_needRadio == 1) then {
								...
								if (evac_call_hasRadio) then {
									...
									if (s_player_evacCall < 0) then {
										s_player_evacCall = player addAction [("<t color=""#0000FF"">" + ("Call Evac-Chopper") + "</t>"),"scripts\evac\CallEvacChopper.sqf",[],-1000,false,false,"",""];
									};
