call compile preprocessFileLineNumbers "scripts\suicide\config.sqf";
...
DZE_CRV_SUICIDE = 3;
// call dependency
call compile preprocessFileLineNumbers "dayz_code\click_actions\init.sqf";
...
{DZE_CLICK_ACTIONS set [count DZE_CLICK_ACTIONS,[_x,"Commit Suicide",format["'%1' execVM 'scripts\suicide\suicide.sqf';",_x],"true"]];} forEach DZE_SUICIDE_WEAPONS;