...
if (((getPosATL _vehicle) select 2) > 150) exitWith {DZE_ActionInProgress = false; cutText ["Your fear of heights prevents you from building!","PLAIN DOWN"];};
...
if (_hasrequireditem) then {
	...
	if !(_classnametmp in DZE_noRotate) then{
		s_player_setVectorsReset = player addaction ["Reset","dayz_code\snap_pro\player_vectorChange.sqf","reset"];
		s_player_setVectorsForward = player addaction ["Pitch Forward","dayz_code\snap_pro\player_vectorChange.sqf","forward"];
		s_player_setVectorsBack = player addaction ["Pitch Back","dayz_code\snap_pro\player_vectorChange.sqf","back"];
		s_player_setVectorsLeft = player addaction ["Bank Left","dayz_code\snap_pro\player_vectorChange.sqf","left"];
		s_player_setVectorsRight = player addaction ["Bank Right","dayz_code\snap_pro\player_vectorChange.sqf","right"];
		s_player_setVectors1 = player addaction ["Increment by 1 degree","dayz_code\snap_pro\player_vectorChange.sqf","1"];
		s_player_setVectors5 = player addaction ["Increment by 5 degrees","dayz_code\snap_pro\player_vectorChange.sqf","5"];
		s_player_setVectors45 = player addaction ["Increment by 45 degrees","dayz_code\snap_pro\player_vectorChange.sqf","45"];
		s_player_setVectors90 = player addaction ["Increment by 90 degrees","dayz_code\snap_pro\player_vectorChange.sqf","90"];
	};
