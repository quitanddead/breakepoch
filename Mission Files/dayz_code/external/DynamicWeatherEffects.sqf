...
if (count _this > 1) then { _initialOvercast = _this select 1; } else { _initialOvercast = 0.1; };
if (count _this > 2) then { _initialRain = _this select 2; } else { _initialRain = 0.1; };
if (count _this > 3) then { _initialWind = _this select 3; } else { _initialWind = [0.2, 0.2]; };
