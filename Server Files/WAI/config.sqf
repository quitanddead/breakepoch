if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_special_humanity			= 20;			// amount of humanity gain or loss for killing a special AI dependant on player alignment
		
		ai_skill_extreme			= [["aimingAccuracy",1.00],["aimingShake",1.00],["aimingSpeed",1.00],["endurance",1.00],["spotDistance",1.00],["spotTime",1.00],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Extreme
		ai_skill_hard				= [["aimingAccuracy",0.80],["aimingShake",0.80],["aimingSpeed",0.80],["endurance",1.00],["spotDistance",0.80],["spotTime",0.80],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Hard
		ai_skill_medium				= [["aimingAccuracy",0.70],["aimingShake",0.70],["aimingSpeed",0.70],["endurance",1.00],["spotDistance",0.70],["spotTime",0.70],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Medium
		ai_skill_easy				= [["aimingAccuracy",0.50],["aimingShake",0.60],["aimingSpeed",0.60],["endurance",1.00],["spotDistance",0.60],["spotTime",0.60],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Easy
		...
		ai_static_array				= [["aimingAccuracy",0.50],["aimingShake",0.80],["aimingSpeed",0.75],["endurance",1.00],["spotDistance",0.75],["spotTime",0.75],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];

		ai_gear0					= [["ItemBandage","ItemBandage","ItemPainkiller","ItemMorphine","FoodMRE","ItemGoldBar"],["ItemKnife","ItemFlashlight","ItemGPS"]];
		ai_gear1					= [["ItemBandage","ItemBandage","ItemPainkiller","ItemMorphine","ItemSodaCoke","ItemSilverBar10oz"],["ItemKnife","ItemFlashlight","ItemGPS"]];
		ai_gear2					= [["ItemBandage","ItemBandage","ItemPainkiller","ItemMorphine","FoodMRE","ItemGoldBar"],["ItemKnife","ItemFlashlight","ItemGPS"]];
		ai_gear3					= [["ItemBandage","ItemBandage","ItemPainkiller","ItemMorphine","ItemSodaCoke","ItemGoldBar2oz"],["ItemKnife","ItemFlashlight","ItemGPS"]];
		ai_gear_random				= [ai_gear0,ai_gear1,ai_gear2,ai_gear3];	// Allows the possibility of random gear

		ai_wep_assault				= [["M16A4_ACG","30Rnd_556x45_Stanag"],["Sa58V_RCO_EP1","30Rnd_762x39_AK47"],["SCAR_L_STD_Mk4CQT","30Rnd_556x45_Stanag"],["M8_sharpshooter","30Rnd_556x45_Stanag"],["M4A1_HWS_GL_camo","30Rnd_556x45_Stanag"],["SCAR_L_STD_HOLO","30Rnd_556x45_Stanag"],["M4A3_CCO_EP1","30Rnd_556x45_Stanag"],["M4A3_CCO_EP1","30Rnd_556x45_Stanag"],["M4A1_AIM_SD_camo","30Rnd_556x45_StanagSD"],["M16A4","30Rnd_556x45_Stanag"],["m8_carbine","30Rnd_556x45_Stanag"],["BAF_L85A2_RIS_Holo","30Rnd_556x45_Stanag"],["Sa58V_CCO_EP1","30Rnd_762x39_AK47"],["SCAR_H_STD_EGLM_Spect","20rnd_762x51_B_SCAR"],["SCAR_H_CQC_CCO","20rnd_762x51_B_SCAR"]];	// Assault
		...
		ai_hero_skin				= ["US_Soldier_SL_EP1","US_Soldier_TL_EP1","US_Soldier_AR_EP1","US_Soldier_AT_EP1","US_Soldier_MG_EP1"];
		ai_bandit_skin				= ["Ins_Soldier_GL_DZ","TK_INS_Soldier_EP1_DZ","TK_INS_Warlord_EP1_DZ","GUE_Commander_DZ","GUE_Soldier_Sniper_DZ","GUE_Soldier_MG_DZ","GUE_Soldier_Crew_DZ","GUE_Soldier_2_DZ","GUE_Soldier_CO_DZ","BanditW1_DZ","BanditW2_DZ","Bandit1_DZ","Bandit2_DZ","RU_Soldier","RU_Soldier_Crew","RU_Soldier_Light"];
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_near_water				= 150;								// nearest water allowed near missions
		
		wai_mission_timer			= [240,600];						// time between missions 5-15 minutes
		wai_mission_timeout			= [1800,2700]; 						// time each missions takes to despawn if inactive 15-30 minutes
		wai_timeout_distance		= 350;								// if a player is this close to a mission then it won't time-out
		...
		crate_items_buildables		= ["forest_large_net_kit","cinder_garage_kit",["PartPlywoodPack",5],"ItemSandbagExLarge5X","park_bench_kit",["CinderBlocks",10],["CinderBlocks",10],["CinderBlocks",10],["metal_floor_kit",2],["metal_floor_kit",2],["metal_floor_kit",2],"ItemCanvas","ItemComboLock",["ItemLightBulb",5],"ItemLockbox",["ItemSandbag",10],["ItemTankTrap",10],["ItemWire",10],["MortarBucket",5],["PartPlankPack",5],"PartWoodPile"];
		...
		crate_items_president		= ["ItemDocument","ItemGoldBar10oz","cinder_garage_kit",["CinderBlocks",10],["metal_floor_kit",2],"FoodCanFrankBeans","ItemSodaMdew","ItemVault"];
