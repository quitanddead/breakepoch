if(isServer) then {
	...
	_mission		= [_position,"Hard","Bunnings Convoy","MainBandit",true] call mission_init;

	diag_log 		format["WAI: [Mission:[Bandit] Bunnings Convoy]: Starting... %1",_position];
	...
	_complete = [
		...
		<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>A heavily guarded Bunnings convoy is taking a lunch break, hero forces are securing the perimeter. Kill them all and make the building supplies yours.</t><br/>
		<br/><t align='left' color='#D60000' shadow='2' size='1.0'>Difficulty: Hard</t><br/><br/>",	// mission announcement
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>Bandits have successfully ambushed the Bunnings convoy and secured the building supplies.</t>",																		// mission success
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>Bandits were unable to surprise the heroes on their lunchbreak.</t>"																// mission fail
	] call mission_winorfail;	

	if(_complete) then {
		[_crate,[4,crate_weapons_buildables],[6,crate_tools_buildable],[30,crate_items_buildables],4] call dynamic_crate;
	};

	diag_log format["WAI: [Mission:[Bandit] Bunnings Convoy]: Ended at %1",_position];
