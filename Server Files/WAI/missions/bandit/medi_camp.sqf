if(isServer) then {
	...
	_complete = [
		...
		<t align='left' color='#FFBF00' shadow='2' size='1.75'>Medical Supply Camp</t><br/><br/><t align='left' color='#ffffff'>A soldier squad have set up a medical re-supply camp. Check your map for the location!</t><br/>
		<br/><t align='left' color='#61B329' shadow='2' size='1.0'>Difficulty: Easy</t><br/><br/>",	// mission announcement
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Medical Supply Camp</t><br/><br/><t align='left' color='#ffffff'>Bandits have taken control of the medical supply camp.</t>",																		// mission success
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Medical Supply Camp</t><br/><br/><t align='left' color='#ffffff'>Bandits did not secure the weapon cache in time.</t>"																// mission fail
