if(isServer) then {
	...
	_complete = [
		...
		<t align='left' color='#FFBF00' shadow='2' size='1.75'>Weapon Cache</t><br/><br/><t align='left' color='#ffffff'>Heroes have obtained a weapon crate! Check your map for the location!</t><br/>
		<br/><t align='left' color='#61B329' shadow='2' size='1.0'>Difficulty: Easy</t><br/><br/>",	// mission announcement
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Weapon Cache</t><br/><br/><t align='left' color='#ffffff'>Bandits have secured the weapon cache.</t>",																		// mission success
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Weapon Cache</t><br/><br/><t align='left' color='#ffffff'>Bandits did not secure the weapon cache in time.</t>"																// mission fail
