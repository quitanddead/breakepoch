if(isServer) then {
	...
	_mission		= [_position,"Easy","Ural Attack","Special",true] call mission_init;
	
	diag_log 		format["WAI: [Mission:[Neutral] Ural Attack]: Starting... %1",_position];
	...
	//Base
	diag_log 		format["WAI: [Mission:[Neutral] Ural Attack]: Spawning Buildings"];
	...
	diag_log format["WAI: [Mission:[Neutral] Ural Attack]: Ended at %1",_position];
