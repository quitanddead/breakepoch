if(isServer) then {
	...
	_mission		= [_position,"Hard","Disabled Convoy","Special",true] call mission_init;

	diag_log 		format["WAI: [Mission:[Neutral] Disabled Convoy]: Starting... %1",_position];
	...
	_complete = [
		...
		<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>A Mitre 10 delivery convoy has been hijacked by bandits, take over the convoy and the building supplies are yours!</t><br/>
		<br/><t align='left' color='#D60000' shadow='2' size='1.0'>Difficulty: Hard</t><br/><br/>",	// mission announcement
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>Survivors have secured the building supplies.</t>",																		// mission success
		"<t align='left' color='#FFBF00' shadow='2' size='1.75'>Supply Convoy</t><br/><br/><t align='left' color='#ffffff'>Survivors did not secure the convoy in time.</t>"																// mission fail
	...
	diag_log format["WAI: [Mission:[Neutral] Disabled Convoy]: Ended at %1",_position];
