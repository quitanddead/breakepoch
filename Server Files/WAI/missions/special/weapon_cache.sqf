if(isServer) then {
	...
	_mission		= [_position,"Medium","Weapon Cache","Special",true] call mission_init;
	
	diag_log 		format["WAI: [Mission:[Neutral] Weapon Cache]: Starting... %1",_position];
	...
	diag_log format["WAI: [Mission:[Neutral] Weapon Cache]: Ended at %1",_position];
