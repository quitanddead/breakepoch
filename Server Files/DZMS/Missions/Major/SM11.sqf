...
_hint = parseText format["<t align='center' color='#FFBF00' shadow='2' size='1.75'>C-130 Crash</t><br/><br/><t align='center' color='#ffffff'>A C130 Carrying Supplies has Crashed!\nBandits are Securing the Cargo!</t><br/><br/><t align='center' color='#5882FA' shadow='2' size='1.0'>Difficulty: Medium</t>"];
...
// Update mission status with debug message
_hint = parseText format["<t align='center' color='#FFBF00' shadow='2' size='1.75'>C-130 Crash</t><br/><br/><t align='center' color='#ffffff'>The Crash Site has been Secured by Survivors!</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";
