...
_hint = parseText format["<t align='center' color='#FFBF00' shadow='2' size='1.75'>Construction Supplies Truck</t><br/><br/><t align='center' color='#ffffff'>A large IKEA construction truck has crashed, locate the crash and loot the truck!</t><br/><br/><t align='center' color='#5882FA' shadow='2' size='1.0'>Difficulty: Medium</t>"];
...
_crate3 = createVehicle ["USVehicleBox",[(_coords select 0) - 14, _coords select 1,0],[], 0, "CAN_COLLIDE"];
[_crate3,"supply"] ExecVM DZMSBoxSetup;
...
diag_log format["[DZMS]: Major SM7 IKEA Truck Mission has Ended."];
