...
/* ********************************************************************************* */
	...
	_UAL = true;		// Anti Spawn Local Vehicle		/* true or false */
	// Anti Spawn Local Vehicle:
	_ALV =
		[
			'M240Nest_DZ','Old_bike_TK_CIV_EP1','Old_bike_TK_INS_EP1','MMT_Civ','TT650_Civ',
			'ATV_US_EP1','CSJ_GyroC','ParachuteWest','ParachuteEast','ParachuteG','ParachuteC','MMT_USMC','JetSkiYanahui_Blue','BAF_L2A1_Tripod_W'
		];
	_UIC = false;	//	replaced by _UAL, vehicle Id check	/* true or false */
...
/*  Key to open the menu  */ _OpenMenuKey = 0x44;    /* google DIK_KeyCodes (0x3C is F2) */
/*  LOW ADMIN HERE        */ _LAdmins = ["76561198082286254","76561197967035142"]; // Cray, Zunz
/*  NORMAL ADMIN HERE     */ _NAdmins = ["76561197960488575","76561198061568644","76561197967035142"]; // Baz, Rabbit, McGiggins
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198100048697","76561198003312030"]; // Anarior, NZBeast
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"];
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Ascent Epoch"; //do not use " in this text.
...
/*  ALLOWED Dialogs       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,55510,711194,711195,51144];
...
//	65431,65432,65433,65434,65440,65441,65442
//	55510 Group Manager
//  711194 Plot Management
//  711195 Door Management
//  51144 Custom ComboUI
/* ********************************************************************************* */
...
[
	...
	"BTC_Hud","#USER:_keyMenu","PlotManagement","DoorManagement","Entercode"
];
/* ********************************************************************************* */
